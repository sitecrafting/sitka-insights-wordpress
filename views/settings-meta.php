<form name="sitka-insights-settings" method="post" autofill="false">
  ...
  <div class="sitka-field sitka-field--flex">
    ...
    <div class="sitka-field sitka-field--flex">
    <div class="sitka-field__label">
      <label><b>Include AI-Powered Results on the search page</b></label>
    </div>
    <div class="sitka-field__input">
      <div class="sitka-field__dym-option">
        <input type="radio" id="sitka_search_ai_results_enabled" name="sitka_search_ai_results_enabled" value="enabled"<?= $data['sitka_search_ai_results_enabled'] === 'enabled' ? 'checked' : '' ?>>
        <label for="sitka_search_ai_results_enabled">Enable</label>
      </div>
      <div class="sitka-field__dym-option">
        <input type="radio" id="sitka_search_ai_results_disabled" name="sitka_search_ai_results_enabled" value="disabled"<?= $data['sitka_search_ai_results_enabled'] !== 'enabled' ? 'checked' : '' ?>>
        <label for="sitka_search_ai_results_disabled">Disable</label>
      </div>
        <p>When this setting is enabled, site results found by AI will appear in search results. Please note: This feature must first be enabled in the Sitka Dashboard. Ask SiteCrafting for details. </p>
    </div>
  </div>

  <div class="sitka-field sitka-field--flex">
    <div class="sitka-field__label">
      <label for="ai_results_heading"><b>AI Results Heading</b></label>
    </div>
    <div class="sitka-field__input">
      <input type="text" id="ai_results_heading" name="sitka_ai_results_heading" value="<?= $data['sitka_ai_results_heading'] ?>">
      <p>Recommend "AI-Powered Search" as a default. This is the heading that will display above the AI results.</p>
    </div>
  </div>

    <div class="sitka-field sitka-field--flex">
    <div class="sitka-field__label">
      <label><b>Include AI-Generated Text with AI Results</b></label>
    </div>
    <div class="sitka-field__input">
      <div class="sitka-field__dym-option">
        <input type="radio" id="sitka_search_ai_results_gen_text_enabled" name="sitka_search_ai_results_gen_text_enabled" value="enabled"<?= $data['sitka_search_ai_results_gen_text_enabled'] === 'enabled' ? 'checked' : '' ?>>
        <label for="sitka_search_ai_results_gen_text_enabled">Enable</label>
      </div>
      <div class="sitka-field__dym-option">
        <input type="radio" id="sitka_search_ai_results_gen_text_disabled" name="sitka_search_ai_results_gen_text_enabled" value="disabled"<?= $data['sitka_search_ai_results_gen_text_enabled'] !== 'enabled' ? 'checked' : '' ?>>
        <label for="sitka_search_ai_results_gen_text_disabled">Disable</label>
      </div>
        <p>When this setting is enabled, text generated by AI will appear in search results. Please note: This feature must first be enabled in the Sitka Dashboard. Ask SiteCrafting for details. </p>
    </div>
  </div>
